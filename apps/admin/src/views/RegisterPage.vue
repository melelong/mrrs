...
const handleFinish = async () => {
  try {
    ...
    const { data } = await adminApi.user.register(registerFormState)
...
const getRegisterCaptcha = async () => {
  try {
    ...
    const { data } = await adminApi.email.registerCaptcha(registerFormState.email)
...
<template>
  <div
    class="register_container w-screen h-screen flex items-center justify-center flex-col text-center select-none bg-bg bg-repeat"
  >
    <div
